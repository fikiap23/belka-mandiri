...
@section('title', 'Ubah Tes Keahlian | Admin BLKM Jabar')
                                ...
                                <div class="col-md-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="post"
                                            ...
                                            <button type="button" class="btn btn-primary mt-2 btn-ubah"
                                                data-id="{{ $tesKeahlian->id }}"
                                                data-nama="{{ $tesKeahlian->nama_tes }}">
                                                Simpan
                                            </button>
